...
public class TimeSheetDAO 
{
	...
	public static int  updateTimeSheet(String columnname, String fromvalue, String tovalue) {
		Query query = EM.getEM().createQuery("UPDATE " + TimeSheet.class.getName() + " SET " + 
	...
	public static ArrayList<TimeSheet> listTimeSheets() {
		Query query = EM.getEM().createQuery("SELECT project FROM " + TimeSheet.class.getName() + " project", TimeSheet.class);
	...
	public static TimeSheet findTimeSheetById(long id) {
		TimeSheet timesheet = EM.getEM().find(TimeSheet.class, new Long(id));
		return timesheet;
	}
